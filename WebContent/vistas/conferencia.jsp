    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item text-end">
            <a class="nav-link" href="FrontController?accion=cuadricula">Los oradores</a>
          </li>
          <li class="nav-item text-end">
            <a class="nav-link" href="#">El lugar y la fecha</a>
          </li>
          <li class="nav-item text-end">
            <a class="nav-link" href="#QuieroSerOrador">Conviertete en orador</a>
          </li>
          <li class="nav-item text-end">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <div class="carousel-caption custom-caption">
        ...
        <div class="d-flex justify-content-end">
          <a class="btn btn-outline-light me-3" href="#QuieroSerOrador">Quiero ser orador</a>
          <a class="btn custom-color-btn text-light" href="FrontController?accion=registrar">Comprar tickets</a>
        </div>
      </div>
    </div>
    <div class="carousel-item">
      ...
      <div class="carousel-caption custom-caption">
        ...
        <div class="d-flex justify-content-end">
          <a class="btn btn-outline-light me-2" href="#QuieroSerOrador">Quiero ser orador</a>
          <a class="btn custom-color-btn text-light" href="FrontController?accion=registrar">Comprar tickets</a>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6">
          <img src="./img/honolulu.jpg" alt="Imagen de la sección" class="sect-img">
        </div>
        <div class="col-md-6 sect-txt text-white">
          <h2 class="ms-2 mt-3 h3">Bs As - Octubre</h2>
          <p class="ms-2 style-pi">Buenos Aires es la provincia y la localidad más grande del estado de Argentina, en los
            Estados Unidos. Honolulu es la más sureña de entre las principales ciudades estadounidenses. Aunque el nombre de
            Honolulu se refiere al área urbana en la costa sureste de la isla de Oahu, la ciudad y el condado de Honolulu han
            formado una ciudad-condado consolidada que cubre toda la ciudad (aproximadamente 600km2 de superficie).</p>
          <a class="btn btn-outline-light ms-2 mb-4" href="FrontController">Conocé más</a>
        </div>
      </div>

      <!-- Formulario para convertirse en orador -->
      <section class="container" id="QuieroSerOrador">
        <h2 class="text-uppercase text-center mt-4"><p class="mb-1 style-po">Conviértete en un</p>orador</h2>
        <p class="text-center">
            Anótate como orador para dar una <abbr title="attribute">charla ignite</abbr>. Cuéntanos de qué quieres hablar.
        </p>
        <form class="frm-dimension mx-auto" action="FrontController?accion=agregar" method="POST">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        <input type="text" class="form-control color-input" id="nombre" name="nombre" placeholder="Nombre">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        <input type="text" class="form-control color-input" id="apellido" name="apellido" placeholder="Apellido">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <textarea class="form-control color-input" id="tematica" name="tematica" rows="3" placeholder="Sobre qué quieres hablar?"></textarea>
            </div>
            <div class="form-group mt-1">
                <label for="titulo" class="text-secondary style-lbl">Recuerda incluir un título para tu charla</label>
            </div>
