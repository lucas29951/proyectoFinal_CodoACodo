...
<html lang="es">
    ...
    <body>
        ...
        <section class="container ctn-section">
            ...
            <form class="frm-dimension mx-auto mt-4" action="FrontController?accion=insert" method="POST">
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group mb-3">
                      <input type="text" class="form-control color-input" id="mail" name="mail" placeholder="Correo">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                      <div class="form-group mb-3">
                          ...
                          <input type="number" class="form-control color-input" id="cant" name="cant" placeholder="cantidad">
                      </div>
                  </div>
                  <div class="col-md-6">
                      <div class="form-group mb-3">
                          <label for="categoria" class="form-label">Categoria</label>
                          <select class="form-control form-select" aria-label="Estudiante" id="categoria" name="categoria">
              ...
              <div class="row">
              <div class="col-md-4">
                  <a class="btn btn-warning text-light mt-3 mb-4 w-100" id="volver" href="FrontController?accion=volver">Volver</a>
                </div>
                <div class="col-md-4">
                  <button type="button" class="btn btn-danger text-light mt-3 mb-4 w-100" id="borrar">Borrar</button>
                </div>
                <div class="col-md-4">
                  <button type="submit" class="btn btn-success text-light mt-3 mb-4 w-100" id="resumen">Comprar</button>
                </div>
              </div>
