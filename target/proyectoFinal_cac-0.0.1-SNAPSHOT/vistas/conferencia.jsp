    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6 sect-txt text-white">
          ...
          <a class="btn btn-outline-light ms-2 mb-4" href="#">Conocé más</a>
        </div>
      </div>
      ...
      <section class="container">
        ...
        <form class="frm-dimension mx-auto">
            ...
            <div class="form-group">
                <textarea class="form-control color-input" id="tema" rows="3" placeholder="Sobre qué quieres hablar?"></textarea>
            </div>
